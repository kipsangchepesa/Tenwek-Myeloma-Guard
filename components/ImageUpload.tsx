...
export const ImageUpload: React.FC<ImageUploadProps> = ({ title, onImageSelect, onClear }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 h-full flex flex-col">
      ...
      {!preview ? (
        <div 
          className="border-2 border-dashed border-slate-300 rounded-lg p-8 text-center hover:border-blue-500 transition-colors cursor-pointer bg-slate-50 flex-grow flex flex-col justify-center items-center"
